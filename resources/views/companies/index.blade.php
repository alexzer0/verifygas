...
<div class="page bg-white">
          ...
          <div class="page-aside-section">
            <div class="list-group">
              <a class="list-group-item justify-content-between" href="javascript:void(0)">
                <span>
                  <i class="icon wb-inbox" aria-hidden="true"></i> Zonas
                </span>
              ...
              <div class="list-group-item" data-plugin="editlist">
                <div class="list-content">
                  ...
                  <div class="item-actions">
                    ...
                    <span class="btn btn-pure btn-icon" data-toggle="list-delete">
  ...
  <div class="page-main">
    ...
    <div class="page-header">
      <h1 class="page-title">Todas las Empresas</h1>
    ...
    <div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
      ...
      <div class="page-content-actions">
        ...
        <div class="btn-group">
          <div class="dropdown">
            <button class="btn btn-icon btn-pure btn-default" data-toggle="dropdown" aria-expanded="false" type="button">
          ...
          <tr data-url="panel.tpl" data-toggle="slidePanel" class="animation-fade" style="animation-fill-mode: backwards; animation-duration: 250ms; animation-delay: 50ms;">
            ...
            <td class="cell-300">
              <a class="avatar" href="javascript:void(0)">
                <img class="img-fluid" src="{{ asset('images/portraits/1.jpg')}}" alt="...">
              </a>
              {{ $company->company_name}}
            </td>
            <td class="cell-300">{{$company->phone }}</td>
